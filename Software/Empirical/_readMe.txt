...
Figure 1: habitsHistogram.do in folder "./Software/Empirical/metaAnalysis"
            The data for the figure are from Havranek et al. (EER, 2017); http://meta-analysis.cz/habits/; file habit.dta

Table 3: usConsDynEmp.do in folder "./Software/Empirical"
            folder "./Software/Empirical/data" contains the Excel dataset with US data (usData_20170927.xls)
            folder "./Software/Empirical/docs" contains LaTeX file tableTemplate.tex (which can be used to produce a pdf with regression results)
Notes
-----
The do files are called by the MAIN Python file in ./Software/Models if the appropriate flags are set.
