...
do MakeTestStringJ;
file write `hh'  %5.3f (m4a1) (teststr) "  & & & IV & " %5.3f (m4r2) " & " %5.3f (m4p2) " \\"_n;
file write `hh' "   (" %5.3f (m4se1) ")  &  &  & &  & \\"_n;

sca ptest = 2*(1-normal(abs(m2a2)/m2se2));
do MakeTestStringJ;
file write `hh' "    & " %5.3f (m2a2) (teststr) " & & IV & " %5.3f (m2r2) " & " %5.3f (m2p2) " \\"_n;
file write `hh' "   &  (" %5.3f (m2se2) ")  &  & &  &   \\"_n;

sca ptest = 2*(1-normal(abs(m3a3)/m3se3));
sca m3a3 = 10000*m3a3;
sca m3se3 = 10000*m3se3;
do MakeTestStringJ;
file write `hh' "    &  & " %9.2f (m3a3) "\text{e$-4$}" (teststr) "  & IV & " %5.3f (m3r2) " & " %5.3f (m3p2) " \\"_n;
file write `hh' "   &  &  (" %9.2f (m3se3) "\text{e$-4$})  & & &  \\"_n;
...
do MakeTestStringJ;
file write `hh'  %9.2f (m7a3) "\text{e$-4$}" (teststr) " & IV & " %5.3f (m7r2) " & " %5.3f (m7p2) " \\"_n;
file write `hh' "  (" %5.3f (m7se1) ") & (" %5.3f (m7se2) ") &  (" %9.2f (m7se3) "\text{e$-4$})  & & &  \\"_n;
