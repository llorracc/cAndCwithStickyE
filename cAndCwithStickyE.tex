...
%\begin{adjustwidth}{-1em}{-1em}
  ...
  \hfill{\tiny \jobname, \today, \DTMcurrenttime}
...
\hypertarget{dynanR2}{}
\hypertarget{Excess-Sensitivity-Flag}{} % R3 response
...
\hypertarget{Matches-Stimulus}{} % R3 response
...
\appendix\input{./cAndCwithStickyE-App.texinput}\end{document}\endinput
