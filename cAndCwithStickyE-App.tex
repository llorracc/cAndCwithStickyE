...
\begin{document}\bibliographystyle{\econtexBibStyle}
	...
	\ifthenelse{\boolean{ifWeb}}{}{\begin{small}}
		\parbox{\textwidth}{
			\begin{center}
				\begin{tabbing}
					\texttt{~~~~PDF:~} \= \= \url{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE.pdf} \kill \\  % This line establishes the locations of the tabs, but is not printed because of the \kill directive
					\texttt{~~~Repo:~} \= \= \url{https://github.com/llorracc/cAndCwithStickyE}  \\
					\texttt{~~~~PDF:~} \> \> \url{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE.pdf} \\
					\texttt{~~~~Web:~} \> \> \url{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE/} \\
					%\texttt{~BibTeX:~} \> \> \url{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE.bib} \\
					%\texttt{Archive:~} \> \> \url{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE.zip} \\
					\texttt{~Slides:~} \> \> Versions to \href{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE-Slides.pdf}{View} or \href{https://www.econ2.jhu.edu/people/ccarroll/papers/cAndCwithStickyE-Slides-Print.pdf}{Print} \\
	...
	\begin{authorsinfo}
		\name{Carroll: Department of Economics, Johns Hopkins University, \url{https://www.econ2.jhu.edu/people/ccarroll/}, \href{mailto:ccarroll@jhu.edu}{\texttt{ccarroll@jhu.edu}}}
